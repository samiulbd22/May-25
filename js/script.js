...
const members = {
    ...
    othersBill      :0,
    runningMonth    :"May-25",
    previousMonth   :"April-25", // new addDecember
    upComingMonth   :"June 1,2025",
    runningMealRate :54,
    ...
    "01814843266":{
        ...
        payment             :{"05/05/25-Cash":4500},
        // running month {"01/07/24-Cash":500}
        stay_cost       :2200,
        garage_cost     :0,
        running_payable :2639,
        running_paid    :4500,
        running_meal    :28,
        // method calling
        preMonth,
    ...
    "01922362569":{
        ...
        post_payable        :3517,
        previous_paid       :5000,
        previous_dining_cost:1325,
        payment             :{"05/05/25-Cash":1400,"19/05/25-Cash":200,"23/05/25-Cash":1000,
			      "30/05/25-Rocket":700,"31/05/25-Cash":300},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
    ...
    "01797816501":{
        ...
        post_payable        :3720,
        previous_paid       :5500,
        previous_dining_cost:1484,
        payment             :{"08/05/25-Cash":4000,"18/05/25-Cash":1000,"30/05/25-Cash":500},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
        running_payable :3159,
        running_paid    :5500,
        running_meal    :36,
        // method calling
        preMonth,
    ...
    "01707474654":{
        ...
        post_payable        :3100,
        previous_paid       :4500,
        previous_dining_cost:1908,
        payment             :{"10/05/25-Cash":4000,"15/05/25-Cash":1000,"25/05/25-Cash":500},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
        running_payable :3963,
        running_paid    :5500,
        running_meal    :52,
        // method calling
        preMonth,
    ...
    "01537664564":{
        ...
        post_payable        :3400,
        previous_paid       :6000,
        previous_dining_cost:2332,
        payment             :{"05/05/25-Cash":4000,"08/05/25-Cash":1000,"21/05/25-Cash":1000},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
    ...
    "01921567438":{
        ...
        payment             :{"02/05/25-Cash":4720,"11/05/25-Cash":2000},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :4722,
        running_paid    :6722,
        running_meal    :57,
        // method calling
        preMonth,
    ...
    "01874857679":{
        ...
        post_payable        :2954,
        previous_paid       :6000,
        previous_dining_cost:1431,
        payment             :{"07/05/25-Cash":1000,"24/05/25-Cash":500,"28/05/25-Cash":500},
        // running month
        stay_cost       :0,
        garage_cost     :0,
        running_payable :-960,
	...
	"01821245430":{
        ...
        previous_paid       :2400,
        previous_dining_cost:2332,
        payment             :{"06/05/25-Cash":500,"10/05/25-Cash":500,"14/05/25-Cash":2000,"27/05/25-Cash":500,"28/05/25-Cash":500},
        // running month
        stay_cost       :0,
        garage_cost     :0,
        running_payable :0,
...
//runningMonthPayment
    if(memberNumber.length === 11){
        if( memberNumber === "01814843266" 
         ...
         || memberNumber === "01537664564" || memberNumber === "01707474654"
         ||memberNumber==="01874857679" || memberNumber === "01821245430"||
            ...
            memberDiningList.innerHTML = `<tr>
                                           ...
                                           <tr>
                                                <td>${members["01707474654"].name}</td>
                                                <td>${members["01707474654"].runningDiningCost()}</td>
                                                <td>${members["01707474654"].runningMonth().diningAdd}</td>
                                                <td class="getMeals">${members["01707474654"].runningMonth().remainDining}</td>
                                                <td>${members["01707474654"].runningMonth().diningDue}</td>
                                            </tr>
                                           <tr>
						...
						if(memberNumber==="01821245430"){
                                            ...
                                            }else if(memberNumber==="01644377150"){
            ...
            if(memberNumber === '01710430501'){
                ...
                costTotalCheck.innerHTML = `<tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="payable">${members["01707474654"].totalPayable()}</td>
                                                <td class="paid-me">${members["01707474654"].running_paid}</td>
                                                <td class="dining-me">${members["01707474654"].runningDiningCost()}</td>
                                                <td class="due-me">${members["01707474654"].runningMonth().diningDue}</td>
                                            </tr>
                                            `;
